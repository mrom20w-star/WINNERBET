      ...
      <div className="w-full max-w-md mx-auto flex flex-col justify-between flex-1 relative z-10 px-2 sm:px-3 pt-1.5 pb-4">
        ...
        <div className="w-full flex items-center justify-between gap-2 py-1">
          ...
          <div className="flex items-center gap-1.5">
            ...
            {/* Hacker Toggle Button: visible in the interface before playing, disappears when game starts */}
            {gameState !== 'playing' && (
              <button
                type="button"
                onClick={() => {
                ...
                className={`px-2 py-1 rounded-lg text-[11px] font-bold flex items-center gap-1.5 border transition-all cursor-pointer ${
                  isHackerEnabled
              ...
              >
                <span className={`w-1.5 h-1.5 rounded-full ${isHackerEnabled ? 'bg-emerald-400 animate-pulse' : 'bg-slate-500'}`}></span>
